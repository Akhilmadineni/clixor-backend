...
API_ALLOWED_KEYS = frozenset(
    {
        ...
        "CLUSTER_CHORE_ROTATION_CLEANUP_BATCH_SIZE",
        "CLUSTER_CHORE_ROTATION_CLEANUP_INTERVAL",
        "CLUSTER_DATABASE_MAX_CONNS",
        "CLUSTER_DATABASE_MIN_CONNS",
        "CLUSTER_DATABASE_URL",
        "CLUSTER_ENV",
        "CLUSTER_HTTP_ADDR",
        "CLUSTER_HTTP_WRITE_TIMEOUT",
        ...
        "CLUSTER_MEDIA_CLEANUP_BATCH_SIZE",
        "CLUSTER_MEDIA_CLEANUP_INTERVAL",
        "CLUSTER_MEDIA_COMPLETION_TIMEOUT",
        "CLUSTER_MEDIA_CONVERSATION_MAX_BYTES",
        "CLUSTER_MEDIA_PENDING_CONVERSATION_MAX_BYTES",
        "CLUSTER_MEDIA_PENDING_CONVERSATION_MAX_COUNT",
        "CLUSTER_MEDIA_PENDING_TTL",
        "CLUSTER_MEDIA_PENDING_USER_MAX_BYTES",
        "CLUSTER_MEDIA_PENDING_USER_MAX_COUNT",
        "CLUSTER_MEDIA_PROVIDER",
        "CLUSTER_MEDIA_PROFILE_MAX_BYTES",
        "CLUSTER_MEDIA_STORED_CONVERSATION_MAX_BYTES",
        "CLUSTER_MEDIA_STORED_CONVERSATION_MAX_COUNT",
        "CLUSTER_MEDIA_STORED_USER_MAX_BYTES",
        "CLUSTER_MEDIA_STORED_USER_MAX_COUNT",
        "CLUSTER_MEDIA_VERIFY_CONCURRENCY",
