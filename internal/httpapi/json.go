...
func writeDomainError(w http.ResponseWriter, err error) {
	...
	case errors.Is(err, domain.ErrQuotaExceeded):
		writeError(w, http.StatusTooManyRequests, "media_quota_exceeded",
			"Media upload or storage quota exceeded. Delete existing media or wait for pending uploads to expire.")
